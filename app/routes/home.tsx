...
import {ArrowRightIcon, ArrowUpRightIcon, ClockIcon, Layers} from "lucide-react";
...
export default function Home() {
  ...
  return (<div className={'home'}>
        ...
        <section className={'hero'}>
          ...
          <h1>Build beautiful places at the speed of thought with Sketchify</h1>
          <p className="subtitle">
            Sketchify is an AI-first design environment that helps you visualize, render, and ship architectural projects faster than ever
          </p>
